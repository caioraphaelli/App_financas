...
export function ForecastConvertDialog({
  forecast,
  categories,
  ...
  const cardMethods = useMemo(() => paymentMethods.filter((pm) => pm.kind === "cartao"), [paymentMethods]);
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle>Converter previsão</DialogTitle>
          <DialogDescription>
            &ldquo;{forecast.description}&rdquo; vira um lançamento real. Escolha se foi um pagamento
            à vista ou uma compra parcelada.
          </DialogDescription>
        </DialogHeader>
            ...
            <form action={handleSubmitTransaction} className="grid gap-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="grid gap-2">
                  ...
                  <Select name="subcategory_id" defaultValue={forecast.subcategory_id ?? ""} disabled={!categoryId} key={categoryId}>
                    <SelectTrigger>
          ...
          <TabsContent value="parcelada" className="mt-4">
            <form action={handleSubmitPurchase} className="grid gap-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                {purchasePaymentMethod === "cartao" && cardMethods.length > 0 && (
                  <div className="grid gap-2">
                    <Label>Cartão</Label>
                    <Select
